...
vox_a = {'bg_column': 11, 'pulse_toggle_on_load': True, 'transition_time': 0.25}
vox_b = {'bg_column': 12, 'pulse_toggle_on_load': True}
vox_c = {'bg_column': 13, 'pulse_toggle_on_load': True}
vox_d = {'bg_column': 14, 'pulse_toggle_on_load': True, 'transition_time': 0.25}
vox_e = {'bg_column': 15, 'pulse_toggle_on_load': True}
vox_f = {'bg_column': 16, 'pulse_toggle_on_load': True}
dropout = {'bg_column': 17, 'pulse_clear': True, 'transition_time': 0}
hp = {'bg_column': 18, 'pulse_toggle_on_load': True}
end = {'bg_column': 19}
